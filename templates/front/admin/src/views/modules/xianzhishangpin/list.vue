				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('xianzhishangpin','线下置换')" @click="zhihuandingdanCrossAddOrUpdateHandler(scope.row,'cross','','','zhuangtai','已置换','已置换,待置换'.split(',')[0])" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none","height":"40px"}'></span>
								线下置换
							</el-button>
							<el-button class="edit" v-if=" isAuth('xianzhishangpin','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
...
import zhihuandingdanCrossAddOrUpdate from "../zhihuandingdan/add-or-update";
	export default {
		...
		methods: {
			...
			zhihuandingdanCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
