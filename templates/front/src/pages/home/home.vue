...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexDirection":"column","background":"#fff","display":"flex"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"width":"80%","margin":"30px auto","position":"relative","background":"#fff","order":"4"}'>
		...
		<div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
			<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>校园资讯</span>
		</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendxianzhishangpin" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>闲置商品推荐</span>
	</div>
	...
	<div v-if="xianzhishangpinRecommend.length" class="list list12 index-pv1 list12xianzhishangpin" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="tab" :style='{"padding":"0","boxShadow":" 0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0 0 0 20px","flexWrap":"wrap","background":"#FFFBFB","display":"flex","width":"170px","height":"auto","order":"2"}'>
	    <template v-for="item,index in recommendList12xianzhishangpin">
		<div v-if="index < 6" @click="recommendIndexClick12(index + 1, 'xianzhishangpin')" class="item" :class="index + 1 == recommendIndex12xianzhishangpin ? 'active' : ''">
			...
			<div :style='{"color":"inherit","fontSize":"14px"}'>{{item[recommendColumn12xianzhishangpin]}}</div>
		</div>
		</template>
		<div class="more" @click="moreBtn('xianzhishangpin')">
	  ...
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in xianzhishangpinRecommend" :key="index" @click="toDetail('xianzhishangpinDetail', item)">
			...
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.shangpinleixing}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('xianzhishangpin')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
...
<!-- 特价商品 -->
<div id="animate_listxianzhishangpin" class="lists animate__animated" :style='{"padding":"0 0 100px","margin":"0 0 0","background":"url(http://codegen.caihongy.cn/20231122/7eef55d4e07f4b0598a9e072cb72541b.png)","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"7"}'>
	...
	<div class="title" :style='{"width":"30%","margin":"30px 10%","lineHeight":"54px","textAlign":"left","background":"none"}'>
	  <span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>闲置商品展示</span>
	</div>
	...
	<div class="list list15 index-pv1" :style='{"padding":"0","margin":"0 auto","alignItems":"center","display":"flex","width":"80%","justifyContent":"center","height":"auto"}'>
	  <div :style='{"width":"32%","height":"auto"}' class="list left">
		<template v-if="xianzhishangpinList.length">
	    <template v-for="item,index in xianzhishangpinList">
		<div v-if="index == 0" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  ...
		  <div class="info">
			...
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinleixing}}</div>
	      </div>
	    </div>
		</template>
		</template>
		<template v-if="xianzhishangpinList.length > 1">
		<template v-for="item,index in xianzhishangpinList">
	    <div v-if="index == 1" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	  ...
	  <div :style='{"width":"32%","margin":"0 2%","height":"auto"}' class="list center">
		<template v-if="xianzhishangpinList.length > 2">
		<template v-for="item,index in xianzhishangpinList">
	    <div v-if="index == 2" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0 0 15px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	    ...
	    <div :style='{"margin":"0 0 15px","alignItems":"center","background":"#fff","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"200px"}' class="box2">
	      <div :style='{"fontSize":"24px","lineHeight":"54px","color":"#000","fontWeight":"bold"}' class="title">{{xianzhishangpinList[2].shangpinmingcheng}}</div>
	    </div>
		<template v-if="xianzhishangpinList.length > 3">
		<template v-for="item,index in xianzhishangpinList">
	    <div v-if="index == 3" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box3 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	  ...
	  <div :style='{"width":"32%","height":"auto"}' class="list right">
	    <template v-if="xianzhishangpinList.length > 4">
	    <template v-for="item,index in xianzhishangpinList">
	    <div v-if="index == 4" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
		...
		<template v-if="xianzhishangpinList.length > 5">
		<template v-for="item,index in xianzhishangpinList">
	    <div v-if="index == 5" @click="toDetail('xianzhishangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
	      <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	...
	<div @click="moreBtn('xianzhishangpin')" :style='{"border":"1px solid #000","margin":"10px auto","top":"30px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"10%"}'>
...
<!-- 特价商品 -->
<div id="animate_listershoushangpin" class="lists animate__animated" :style='{"padding":"0 0 100px","margin":"0 0 0","background":"url(http://codegen.caihongy.cn/20231122/7eef55d4e07f4b0598a9e072cb72541b.png)","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"7"}'>
	<div v-if="false" class="idea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
	...
	<div class="title" :style='{"width":"30%","margin":"30px 10%","lineHeight":"54px","textAlign":"left","background":"none"}'>
	  <span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>二手商品展示</span>
	</div>
	...
	<div class="list list15 index-pv1" :style='{"padding":"0","margin":"0 auto","alignItems":"center","display":"flex","width":"80%","justifyContent":"center","height":"auto"}'>
	  <div :style='{"width":"32%","height":"auto"}' class="list left">
		<template v-if="ershoushangpinList.length">
	    <template v-for="item,index in ershoushangpinList">
		<div v-if="index == 0" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
		...
		<template v-if="ershoushangpinList.length > 1">
		<template v-for="item,index in ershoushangpinList">
	    <div v-if="index == 1" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	  ...
	  <div :style='{"width":"32%","margin":"0 2%","height":"auto"}' class="list center">
		<template v-if="ershoushangpinList.length > 2">
		<template v-for="item,index in ershoushangpinList">
	    <div v-if="index == 2" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0 0 15px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	    ...
	    <div :style='{"margin":"0 0 15px","alignItems":"center","background":"#fff","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"200px"}' class="box2">
	      <div :style='{"fontSize":"24px","lineHeight":"54px","color":"#000","fontWeight":"bold"}' class="title">{{ershoushangpinList[2].shangpinmingcheng}}</div>
	    </div>
		<template v-if="ershoushangpinList.length > 3">
		<template v-for="item,index in ershoushangpinList">
	    <div v-if="index == 3" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box3 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	  ...
	  <div :style='{"width":"32%","height":"auto"}' class="list right">
	    <template v-if="ershoushangpinList.length > 4">
	    <template v-for="item,index in ershoushangpinList">
	    <div v-if="index == 4" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0 0 30px","position":"relative","background":"#fff","height":"auto"}' class="box1 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
		  <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
		...
		<template v-if="ershoushangpinList.length > 5">
		<template v-for="item,index in ershoushangpinList">
	    <div v-if="index == 5" @click="toDetail('ershoushangpinDetail', item)" :style='{"width":"100%","margin":"0","position":"relative","background":"#fff","height":"auto"}' class="box2 list-item animation-box">
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
		  <img :name="item.id" :style='{"width":"100% ","objectFit":"cover","display":"block","height":"300px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
	      <div class="info">
			<div class="line1" :style='{"color":"#fff","fontSize":"24px","lineHeight":"54px"}'>{{item.shangpinmingcheng}}</div>
	...
	<div @click="moreBtn('ershoushangpin')" :style='{"border":"1px solid #000","margin":"10px auto","top":"30px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#000","fontSize":"12px"}'>更多</span>
		<i :style='{"color":"#000","fontSize":"12px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
  ...
  export default {
    ...
    data() {
      return {
		...
		recommendIndex12xianzhishangpin: 0,
		recommendList12xianzhishangpin: [],
		recommendColumn12xianzhishangpin: '',
    ...
    created() {
		...
		this.getList();
		this.xianzhishangpinRecommendCate()
    },
	mounted() {
    ...
    methods: {
		...
		xianzhishangpinRecommendCate(){
			this.$http.get('shangpinleixing/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12xianzhishangpin = res.data.data.list
			  }
			});
			this.recommendColumn12xianzhishangpin = 'shangpinleixing'
		},
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendxianzhishangpin',css:'animate__rubberBand'},
				{id:'animate_listxianzhishangpin',css:'animate__flash'},
				{id:'animate_listershoushangpin',css:'animate__flash'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "xianzhishangpin/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "xianzhishangpin/autoSort2";
          }
			data = {
				page: 1,
				limit: 6,
			}
			if(this.recommendIndex12xianzhishangpin != 0){
				data.shangpinleixing = this.recommendList12xianzhishangpin[this.recommendIndex12xianzhishangpin - 1].shangpinleixing
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.xianzhishangpinRecommend = res.data.data.list;
			...
			this.$http.get('xianzhishangpin/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.xianzhishangpinList = res.data.data.list;
