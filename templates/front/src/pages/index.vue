	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"border":"1px solid #fff","boxShadow":"none","padding":"0 10%","alignItems":"center","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#BFD0CA","borderWidth":"0 0 90px","width":"100%","position":"absolute","height":"140px","zIndex":"1002"}'>
			...
			<div :style='{"position":"absolute","top":"70px","left":"10%","display":"block","zIndex":"999"}'>
			  <span :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"30px","color":"#000","float":"left","fontWeight":"bold"}'>基于Python的校园个人闲置物品换购平台的设计与开发</span>
			</div>
			...
			<div :style='{"cursor":"pointer","padding":"0 12px","fontSize":"14px","lineHeight":"32px","color":"#000","height":"32px"}' @click="goBackend">后台管理</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-discover","buttons":["新增","查看","修改","删除"],"menu":"置换账户","menuJump":"列表","tableName":"zhihuanzhanghu"}],"menu":"置换账户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-pic","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-camera","buttons":["新增","查看","修改","删除"],"menu":"商品类型","menuJump":"列表","tableName":"shangpinleixing"}],"menu":"商品类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线下置换"],"appFrontIcon":"cuIcon-form","buttons":["查看","修改","删除","查看评论"],"menu":"闲置商品","menuJump":"列表","tableName":"xianzhishangpin"}],"menu":"闲置商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-news","buttons":["查看","修改","删除"],"menu":"置换订单","menuJump":"列表","tableName":"zhihuandingdan"}],"menu":"置换订单管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线上购买"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","修改","删除","查看评论"],"menu":"二手商品","menuJump":"列表","tableName":"ershoushangpin"}],"menu":"二手商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","修改","删除"],"menu":"购买订单","menuJump":"列表","tableName":"goumaidingdan"}],"menu":"购买订单管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["查看","修改","删除"],"menu":"交流论坛","tableName":"forum"}],"menu":"交流论坛"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-discover","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-goodsnew","buttons":["查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"校园资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"校园资讯分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线下置换"],"appFrontIcon":"cuIcon-phone","buttons":["查看评论","查看","线下置换"],"menu":"闲置商品列表","menuJump":"列表","tableName":"xianzhishangpin"}],"menu":"闲置商品模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线上购买"],"appFrontIcon":"cuIcon-vip","buttons":["线上购买","查看评论","查看"],"menu":"二手商品列表","menuJump":"列表","tableName":"ershoushangpin"}],"menu":"二手商品模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线下置换"],"appFrontIcon":"cuIcon-form","buttons":["新增","查看","修改","删除","查看评论"],"menu":"闲置商品","menuJump":"列表","tableName":"xianzhishangpin"}],"menu":"闲置商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-news","buttons":["审核","查看","删除"],"menu":"置换订单","menuJump":"列表","tableName":"zhihuandingdan"}],"menu":"置换订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线下置换"],"appFrontIcon":"cuIcon-phone","buttons":["查看评论","查看","线下置换"],"menu":"闲置商品列表","menuJump":"列表","tableName":"xianzhishangpin"}],"menu":"闲置商品模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线上购买"],"appFrontIcon":"cuIcon-vip","buttons":["线上购买","查看评论","查看"],"menu":"二手商品列表","menuJump":"列表","tableName":"ershoushangpin"}],"menu":"二手商品模块"}],"hasBackLogin":"是","hasBackRegister":"是","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"置换账户","tableName":"zhihuanzhanghu"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-news","buttons":["查看","删除"],"menu":"置换订单","menuJump":"列表","tableName":"zhihuandingdan"}],"menu":"置换订单管理"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线上购买"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除","查看评论"],"menu":"二手商品","menuJump":"列表","tableName":"ershoushangpin"}],"menu":"二手商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["删除","查看","支付","审核"],"menu":"购买订单","menuJump":"列表","tableName":"goumaidingdan"}],"menu":"购买订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线下置换"],"appFrontIcon":"cuIcon-phone","buttons":["查看评论","查看","线下置换"],"menu":"闲置商品列表","menuJump":"列表","tableName":"xianzhishangpin"}],"menu":"闲置商品模块"},{"child":[{"allButtons":["新增","查看","修改","删除","查看评论","线上购买"],"appFrontIcon":"cuIcon-vip","buttons":["线上购买","查看评论","查看"],"menu":"二手商品列表","menuJump":"列表","tableName":"ershoushangpin"}],"menu":"二手商品模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
